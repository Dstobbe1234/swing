# import math
# print(math.atan2(-49, 3) * 180/math.pi)
...
#                 bobSpeed = math.sqrt(bobSpeedVectors[0] ** 2 + bobSpeedVectors[1] ** 2) / (radius)  * (xDiff / abs(xDiff)) * (bobSpeedVectors[1] / abs(bobSpeedVectors[1]))
#                 mouse = True
